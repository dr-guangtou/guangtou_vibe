#!/usr/bin/env python
"""
Official HSC SQL Query Client (DR4)
Source: https://hsc-gitlab.mtk.nao.ac.jp/ssp-software/data-access-tools/-/blob/master/dr4/catalogQuery/hscSspQuery3.py

This is the official HSC catalog query tool maintained by the HSC-SSP team.
Use this script rather than custom implementations to ensure compatibility.
"""
